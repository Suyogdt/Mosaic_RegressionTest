...
public class CommonUtilities extends DriverInitialization{
    public WebDriver driver;
        ...
        public boolean isElement_PresentOnPage(By elementToPresent , WebDriver driver){
        ...
        public boolean isElement_DisplayedOnPage(By elementToDisplayed, WebDriver driver){
            driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
        ...
        public void click_ElementOnPage(By elementToClick, WebDriver driver){
        ...
        public void clear_InputBoxOnPage(By textBoxToClear, WebDriver driver){
        ...
        public void enterText_InputBoxOnPage(By enterTextElement, String text, WebDriver driver, WebDriverWait wait){
        ...
        public String getText_FromElementOnPage(By elementToGetText, WebDriver driver){
